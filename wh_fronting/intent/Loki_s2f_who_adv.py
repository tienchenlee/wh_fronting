...
if __name__ == "__main__":
    ...
    resultDICT = getResult("張三見過瑪莉好幾次", "張三見過瑪莉好幾次", [], {}, {})
    pprint(resultDICT)